            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        {{$item->name}}
                        <a style='float: right;' href='/item-manage' class="btn btn-primary">
                            {{ __('Back') }}
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sellerItem.submit', $item->id) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="textarea" class="form-control @error('description') is-invalid @enderror" name="description" value="{{$item->description}}" required autocomplete="description" autofocus>
